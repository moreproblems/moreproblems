...
export class TemplateStateComponent implements OnInit {
  ...
  constructor(public router: Router, private aRoute: ActivatedRoute, private titleService: Title, private meta: Meta, public authService: AuthService, private afAuth: AngularFireAuth, private http: HttpClient) {
