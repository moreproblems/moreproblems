...
import * as problemsData from "src/assets/problems/TX22G5S/TX22G5S-problems.json";
...
@Component({
    selector: 'app-TX22G5S-key',
    templateUrl: './TX22G5S-key.component.html',
    styleUrls: ['./TX22G5S-key.component.css']
})

@Injectable()
export class TX22G5SKeyComponent implements OnInit {
    title = 'More Problems';
