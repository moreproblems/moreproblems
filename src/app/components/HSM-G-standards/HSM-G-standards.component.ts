...
@Component({
  selector: 'app-HSM-G-standards',
  templateUrl: './HSM-G-standards.component.html',
  styleUrls: ['./HSM-G-standards.component.css']
})

@Injectable()
export class HSMGStandardsComponent implements OnInit {
  title = 'More Problems';
