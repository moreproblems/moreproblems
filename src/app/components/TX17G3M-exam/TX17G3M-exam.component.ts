...
@Component({
    selector: 'app-TX17G3M-exam',
    templateUrl: './TX17G3M-exam.component.html',
    styleUrls: ['./TX17G3M-exam.component.css']
})

@Injectable()
export class TX17G3MExamComponent implements OnInit {
    title = 'More Problems';
    ...
    TX17G3M_exam_dump: { [key: number]: { 'Number': number, 'Type': string, 'NumChoices': number, 'Topic': string, 'SubTopic': string, 'Content': string[], 'AnswerChoices': { [key: string]: { 'Choice': string, 'Key': { 'Correct': boolean, 'Rationale': string } } } } } = problemsData;
