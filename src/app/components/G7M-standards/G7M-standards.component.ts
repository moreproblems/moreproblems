...
@Component({
  selector: 'app-G7M-standards',
  templateUrl: './G7M-standards.component.html',
  styleUrls: ['./G7M-standards.component.css']
})

@Injectable()
export class G7MStandardsComponent implements OnInit {
  title = 'More Problems';
