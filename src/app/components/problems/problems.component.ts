...
export class ProblemsComponent implements OnInit {
  ...
  toggle_button(val: string) {
    if (['Biology', 'English Reading', 'English Writing', 'Mathematics', 'Science', 'Social Studies', 'U.S. History'].includes(val)) {
