...
export class ProblemsComponent implements OnInit {
  ...
  toggle_button(val: string) {
    if (['Algebra I', 'Biology', 'English I', 'English II', 'English Reading', 'English Writing', 'Mathematics', 'Science', 'Social Studies', 'U.S. History'].includes(val)) {
  ...
  generate_problems() {
    ...
    if (this.filtered_set.includes('TX19G3R')) {
      for (const [num, value] of Object.entries(this.TX19G3R_exam_dump)) {
        if (value.Number <= 34) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX18G3R')) {
      for (const [num, value] of Object.entries(this.TX18G3R_exam_dump)) {
        if (value.Number <= 34) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX17G3R')) {
      for (const [num, value] of Object.entries(this.TX17G3R_exam_dump)) {
        if (value.Number <= 34) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX22G4R')) {
      for (const [num, value] of Object.entries(this.TX22G4R_exam_dump)) {
        if (value.Number <= 36) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX21G4R')) {
      for (const [num, value] of Object.entries(this.TX21G4R_exam_dump)) {
        if (value.Number <= 36) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX19G4R')) {
      for (const [num, value] of Object.entries(this.TX19G4R_exam_dump)) {
        if (value.Number <= 36) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX19G4R'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX18G4R')) {
      for (const [num, value] of Object.entries(this.TX18G4R_exam_dump)) {
        if (value.Number <= 36) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX18G4R'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX17G4R')) {
      for (const [num, value] of Object.entries(this.TX17G4R_exam_dump)) {
        if (value.Number <= 36) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX17G4R'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX22G5R')) {
      for (const [num, value] of Object.entries(this.TX22G5R_exam_dump)) {
        if (value.Number <= 38) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX21G5R')) {
      for (const [num, value] of Object.entries(this.TX21G5R_exam_dump)) {
        if (value.Number <= 38) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX19G5R')) {
      for (const [num, value] of Object.entries(this.TX19G5R_exam_dump)) {
        if (value.Number <= 38) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX19G5R'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX18G5R')) {
      for (const [num, value] of Object.entries(this.TX18G5R_exam_dump)) {
        if (value.Number <= 38) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX18G5R'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX17G5R')) {
      for (const [num, value] of Object.entries(this.TX17G5R_exam_dump)) {
        if (value.Number <= 38) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX17GR'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX22G6R')) {
      for (const [num, value] of Object.entries(this.TX22G6R_exam_dump)) {
        if (value.Number <= 40) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX21G6R')) {
      for (const [num, value] of Object.entries(this.TX21G6R_exam_dump)) {
        if (value.Number <= 40) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX19G6R')) {
      for (const [num, value] of Object.entries(this.TX19G6R_exam_dump)) {
        if (value.Number <= 40) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX19G6R'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX18G6R')) {
      for (const [num, value] of Object.entries(this.TX18G6R_exam_dump)) {
        if (value.Number <= 40) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX18G6R'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX17G6R')) {
      for (const [num, value] of Object.entries(this.TX17G6R_exam_dump)) {
        if (value.Number <= 40) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX17G6R'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX22G7R')) {
      for (const [num, value] of Object.entries(this.TX22G7R_exam_dump)) {
        if (value.Number <= 42) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX21G7R')) {
      for (const [num, value] of Object.entries(this.TX21G7R_exam_dump)) {
        if (value.Number <= 42) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX19G7R')) {
      for (const [num, value] of Object.entries(this.TX19G7R_exam_dump)) {
        if (value.Number <= 42) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX19G7R'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX18G7R')) {
      for (const [num, value] of Object.entries(this.TX18G7R_exam_dump)) {
        if (value.Number <= 42) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX18G7R'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX17G7R')) {
      for (const [num, value] of Object.entries(this.TX17G7R_exam_dump)) {
        if (value.Number <= 42) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX17G7R'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX22G8R')) {
      for (const [num, value] of Object.entries(this.TX22G8R_exam_dump)) {
        if (value.Number <= 44) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX21G8R')) {
      for (const [num, value] of Object.entries(this.TX21G8R_exam_dump)) {
        if (value.Number <= 44) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX19G8R')) {
      for (const [num, value] of Object.entries(this.TX19G8R_exam_dump)) {
        if (value.Number <= 44) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX19G8R'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX18G8R')) {
      for (const [num, value] of Object.entries(this.TX18G8R_exam_dump)) {
        if (value.Number <= 44) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX18G8R'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX17G8R')) {
      for (const [num, value] of Object.entries(this.TX17G8R_exam_dump)) {
        if (value.Number <= 44) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX17G8R'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX22HSA1')) {
      for (const [num, value] of Object.entries(this.TX22HSA1_exam_dump)) {
        if (value.Number <= 54) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX22HSA1'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX21HSA1')) {
      for (const [num, value] of Object.entries(this.TX21HSA1_exam_dump)) {
        if (value.Number <= 54) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX21HSA1'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX19HSA1')) {
      for (const [num, value] of Object.entries(this.TX19HSA1_exam_dump)) {
        if (value.Number <= 54) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX19HSA1'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX18HSA1')) {
      for (const [num, value] of Object.entries(this.TX18HSA1_exam_dump)) {
        if (value.Number <= 54) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX18HSA1'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX17HSA1')) {
      for (const [num, value] of Object.entries(this.TX17HSA1_exam_dump)) {
        if (value.Number <= 54) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX17HSA1'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX22HSB')) {
      for (const [num, value] of Object.entries(this.TX22HSB_exam_dump)) {
        if (value.Number <= 50) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX21HSB')) {
      for (const [num, value] of Object.entries(this.TX21HSB_exam_dump)) {
        if (value.Number <= 50) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX19HSB')) {
      for (const [num, value] of Object.entries(this.TX19HSB_exam_dump)) {
        if (value.Number <= 50) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX18HSB')) {
      for (const [num, value] of Object.entries(this.TX18HSB_exam_dump)) {
        if (value.Number <= 54) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX18HSB'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX17HSB')) {
      for (const [num, value] of Object.entries(this.TX17HSB_exam_dump)) {
        if (value.Number <= 54) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX17HSB'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX22HSE1')) {
      for (const [num, value] of Object.entries(this.TX22HSE1_exam_dump)) {
        if (value.Number <= 53) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX22HSE1'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX21HSE1')) {
      for (const [num, value] of Object.entries(this.TX21HSE1_exam_dump)) {
        if (value.Number <= 53) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX21HSE1'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX19HSE1')) {
      for (const [num, value] of Object.entries(this.TX19HSE1_exam_dump)) {
        if (value.Number <= 53) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX19HSE1'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX18HSE1')) {
      for (const [num, value] of Object.entries(this.TX18HSE1_exam_dump)) {
        if (value.Number <= 53) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX18HSE1'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX17HSE1')) {
      for (const [num, value] of Object.entries(this.TX17HSE1_exam_dump)) {
        if (value.Number <= 53) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX17HSE1'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX22HSE2')) {
      for (const [num, value] of Object.entries(this.TX22HSE2_exam_dump)) {
        if (value.Number <= 53) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX22HSE2'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX21HSE2')) {
      for (const [num, value] of Object.entries(this.TX21HSE2_exam_dump)) {
        if (value.Number <= 53) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX21HSE2'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX19HSE2')) {
      for (const [num, value] of Object.entries(this.TX19HSE2_exam_dump)) {
        if (value.Number <= 53) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX19HSE2'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX18HSE2')) {
      for (const [num, value] of Object.entries(this.TX18HSE2_exam_dump)) {
        if (value.Number <= 53) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX18HSE2'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX17HSE2')) {
      for (const [num, value] of Object.entries(this.TX17HSE2_exam_dump)) {
        if (value.Number <= 53) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX17HSE2'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX22HSUSH')) {
      for (const [num, value] of Object.entries(this.TX22HSUSH_exam_dump)) {
        if (value.Number <= 68) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX21HSUSH')) {
      for (const [num, value] of Object.entries(this.TX21HSUSH_exam_dump)) {
        if (value.Number <= 68) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
    ...
    if (this.filtered_set.includes('TX17HSUSH')) {
      for (const [num, value] of Object.entries(this.TX17HSUSH_exam_dump)) {
        if (value.Number <= 68) {
          if (this.topic_filters.length == 0) {
            this.ordered_dump[this.dump_count] = value;
            this.dump_count += 1;
          }
          else if (!this.exam_attribute_dump['TX17HSUSH'].HideTopics) {
            for (let topic of value.Topics) {
              if (this.topic_filters.includes(topic)) {
                this.ordered_dump[this.dump_count] = value;
                this.dump_count += 1;
  ...
  attempt_lr_problem(response: string) {
    if (response != this.problem_selection) {
      this.problem_selection = response;
      this.problem_attempts += 1;
    }
  }
