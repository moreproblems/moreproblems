...
export class ExamsComponent implements OnInit {
  ...
  constructor(public router: Router, private titleService: Title, private meta: Meta, public authService: AuthService) { }
