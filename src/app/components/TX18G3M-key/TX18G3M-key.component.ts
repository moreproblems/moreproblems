...
import * as problemsData from "src/assets/problems/TX18G3M/TX18G3M-problems.json";
...
@Component({
    selector: 'app-TX18G3M-key',
    templateUrl: '../template-key/template-key.component.html',
    styleUrls: ['./TX18G3M-key.component.css']
})

@Injectable()
export class TX18G3MKeyComponent implements OnInit {
    title = 'More Problems';
