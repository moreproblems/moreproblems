...
@Component({
  selector: 'app-G3E-standards',
  templateUrl: './G3E-standards.component.html',
  styleUrls: ['./G3E-standards.component.css']
})

@Injectable()
export class G3EStandardsComponent implements OnInit {
  title = 'More Problems';
