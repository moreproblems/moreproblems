...
@Component({
    selector: 'app-TX21G8SS-exam',
    templateUrl: './TX21G8SS-exam.component.html',
    styleUrls: ['./TX21G8SS-exam.component.css']
})

@Injectable()
export class TX21G8SSExamComponent implements OnInit {
    title = 'More Problems';
    ...
    TX21G8SS_exam_dump: { [key: number]: { 'Number': number, 'Type': string, 'NumChoices': number, 'Topic': string, 'SubTopic': string, 'Content': string[], 'AnswerChoices': { [key: string]: { 'Choice': string, 'Key': { 'Correct': boolean, 'Rationale': string } } } } } = problemsData;
