...
export class TemplateEditQuizComponent implements OnInit {
  ...
  constructor(public router: Router, public authService: AuthService, private afAuth: AngularFireAuth, private http: HttpClient, private aRoute: ActivatedRoute, private sanitizer: DomSanitizer) { }
