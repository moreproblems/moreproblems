...
@Component({
  selector: 'app-G1E-standards',
  templateUrl: './G1E-standards.component.html',
  styleUrls: ['./G1E-standards.component.css']
})

@Injectable()
export class G1EStandardsComponent implements OnInit {
  title = 'More Problems';
