...
@Component({
  selector: 'app-G3M-standards',
  templateUrl: './G3M-standards.component.html',
  styleUrls: ['./G3M-standards.component.css']
})

@Injectable()
export class G3MStandardsComponent implements OnInit {
  title = 'More Problems';
