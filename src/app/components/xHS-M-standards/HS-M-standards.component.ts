...
@Component({
  selector: 'app-HS-M-standards',
  templateUrl: './HS-M-standards.component.html',
  styleUrls: ['./HS-M-standards.component.css']
})

@Injectable()
export class HSModStandardsComponent implements OnInit {
  title = 'More Problems';
