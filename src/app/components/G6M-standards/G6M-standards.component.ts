...
@Component({
  selector: 'app-G6M-standards',
  templateUrl: './G6M-standards.component.html',
  styleUrls: ['./G6M-standards.component.css']
})

@Injectable()
export class G6MStandardsComponent implements OnInit {
  title = 'More Problems';
