...
@Component({
  selector: 'app-KM-standards',
  templateUrl: './KM-standards.component.html',
  styleUrls: ['./KM-standards.component.css']
})

@Injectable()
export class KMStandardsComponent implements OnInit {
  title = 'More Problems';
