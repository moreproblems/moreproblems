...
@Component({
  selector: 'app-G4E-standards',
  templateUrl: './G4E-standards.component.html',
  styleUrls: ['./G4E-standards.component.css']
})

@Injectable()
export class G4EStandardsComponent implements OnInit {
  title = 'More Problems';
