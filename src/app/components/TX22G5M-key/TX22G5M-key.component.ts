...
import * as problemsData from "src/assets/problems/TX22G5M/TX22G5M-problems.json";
...
@Component({
    selector: 'app-TX22G5M-key',
    templateUrl: '../template-key/template-key.component.html',
    styleUrls: ['./TX22G5M-key.component.css']
})

@Injectable()
export class TX22G5MKeyComponent implements OnInit {
    title = 'More Problems';
