...
@Component({
    ...
    templateUrl: './TX22G5S-exam.component.html',
...
export class TX22G5SExamComponent implements OnInit {
    ...
    TX22G5S_exam_dump: { [key: number]: { 'Number': number, 'Type': string, 'NumChoices': number, 'Topic': string, 'SubTopic': string, 'Content': string[], 'AnswerChoices': { [key: string]: { 'Choice': string, 'Key': { 'Correct': boolean, 'Rationale': string } } } } } = problemsData;
