...
@Component({
    selector: 'app-TX19G8SS-key',
    templateUrl: './TX19G8SS-key.component.html',
    styleUrls: ['./TX19G8SS-key.component.css']
})

@Injectable()
export class TX19G8SSKeyComponent implements OnInit {
    title = 'More Problems';
