...
import * as problemsData from "src/assets/problems/TX18G4M/TX18G4M-problems.json";
...
@Component({
    selector: 'app-TX18G4M-exam',
    templateUrl: './TX18G4M-exam.component.html',
    styleUrls: ['./TX18G4M-exam.component.css']
})

@Injectable()
export class TX18G4MExamComponent implements OnInit {
    title = 'More Problems';
    ...
    TX18G4M_exam_dump: { [key: number]: { 'Number': number, 'Type': string, 'NumChoices': number, 'Topic': string, 'SubTopic': string, 'Content': string[], 'AnswerChoices': { [key: string]: { 'Choice': string, 'Key': { 'Correct': boolean, 'Rationale': string } } } } } = problemsData;
