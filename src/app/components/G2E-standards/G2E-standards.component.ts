...
@Component({
  selector: 'app-G2E-standards',
  templateUrl: './G2E-standards.component.html',
  styleUrls: ['./G2E-standards.component.css']
})

@Injectable()
export class G2EStandardsComponent implements OnInit {
  title = 'More Problems';
