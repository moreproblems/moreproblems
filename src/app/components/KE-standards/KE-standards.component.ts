...
@Component({
  selector: 'app-KE-standards',
  templateUrl: './KE-standards.component.html',
  styleUrls: ['./KE-standards.component.css']
})

@Injectable()
export class KEStandardsComponent implements OnInit {
  title = 'More Problems';
