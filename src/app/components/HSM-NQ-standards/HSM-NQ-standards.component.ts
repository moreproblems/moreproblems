...
@Component({
  selector: 'app-HSM-NQ-standards',
  templateUrl: './HSM-NQ-standards.component.html',
  styleUrls: ['./HSM-NQ-standards.component.css']
})

@Injectable()
export class HSMNQStandardsComponent implements OnInit {
  title = 'More Problems';
