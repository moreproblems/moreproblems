...
@Component({
    selector: 'app-TX17G5M-exam',
    templateUrl: '../template-exam/template-exam.component.html',
    styleUrls: ['./TX17G5M-exam.component.css']
})

@Injectable()
export class TX17G5MExamComponent implements OnInit {
    title = 'More Problems';
    ...
    TX17G5M_exam_dump: { [key: number]: { 'Number': number, 'Type': string, 'NumChoices': number, 'Topics': string[], 'SubTopics': string[], 'Content': string[], 'AnswerChoices': { [key: string]: { 'Choice': string, 'Key': { 'Correct': boolean, 'Rationale': string } } } } } = problemsData;
