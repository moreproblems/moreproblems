...
@Component({
  selector: 'app-G8E-standards',
  templateUrl: './G8E-standards.component.html',
  styleUrls: ['./G8E-standards.component.css']
})

@Injectable()
export class G8EStandardsComponent implements OnInit {
  title = 'More Problems';
