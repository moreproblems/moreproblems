...
@Component({
  selector: 'app-HS-NQ-standards',
  templateUrl: './HS-NQ-standards.component.html',
  styleUrls: ['./HS-NQ-standards.component.css']
})

@Injectable()
export class HSNQStandardsComponent implements OnInit {
  title = 'More Problems';
