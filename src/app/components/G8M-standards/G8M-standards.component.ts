...
@Component({
  selector: 'app-G8M-standards',
  templateUrl: './G8M-standards.component.html',
  styleUrls: ['./G8M-standards.component.css']
})

@Injectable()
export class G8MStandardsComponent implements OnInit {
  title = 'More Problems';
