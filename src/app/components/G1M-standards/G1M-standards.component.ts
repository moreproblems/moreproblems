...
@Component({
  selector: 'app-G1M-standards',
  templateUrl: './G1M-standards.component.html',
  styleUrls: ['./G1M-standards.component.css']
})

@Injectable()
export class G1MStandardsComponent implements OnInit {
  title = 'More Problems';
