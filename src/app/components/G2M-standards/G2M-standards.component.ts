...
@Component({
  selector: 'app-G2M-standards',
  templateUrl: './G2M-standards.component.html',
  styleUrls: ['./G2M-standards.component.css']
})

@Injectable()
export class G2MStandardsComponent implements OnInit {
  title = 'More Problems';
