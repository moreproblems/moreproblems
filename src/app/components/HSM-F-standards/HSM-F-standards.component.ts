...
@Component({
  selector: 'app-HSM-F-standards',
  templateUrl: './HSM-F-standards.component.html',
  styleUrls: ['./HSM-F-standards.component.css']
})

@Injectable()
export class HSMFStandardsComponent implements OnInit {
  title = 'More Problems';
