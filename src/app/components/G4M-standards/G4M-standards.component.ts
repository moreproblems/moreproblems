...
@Component({
  selector: 'app-G4M-standards',
  templateUrl: './G4M-standards.component.html',
  styleUrls: ['./G4M-standards.component.css']
})

@Injectable()
export class G4MStandardsComponent implements OnInit {
  title = 'More Problems';
