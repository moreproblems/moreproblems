...
@Component({
  selector: 'app-HSM-SP-standards',
  templateUrl: './HSM-SP-standards.component.html',
  styleUrls: ['./HSM-SP-standards.component.css']
})

@Injectable()
export class HSMSPStandardsComponent implements OnInit {
  title = 'More Problems';
