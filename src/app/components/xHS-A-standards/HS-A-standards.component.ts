...
@Component({
  selector: 'app-HS-A-standards',
  templateUrl: './HS-A-standards.component.html',
  styleUrls: ['./HS-A-standards.component.css']
})

@Injectable()
export class HSAStandardsComponent implements OnInit {
  title = 'More Problems';
